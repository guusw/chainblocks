...
set(Boost_DEBUG ON)
find_package(boost_context 1.78.0 REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(boost_filesystem 1.78.0 REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
if(WIN32)
  find_package(boost_stacktrace_windbg 1.78.0 REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
endif()
find_package(SDL2 REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(nlohmann_json REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(kcp REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(magic_enum REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(nameof REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(pareto REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(replxx REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(spdlog REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(wasm3 REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(Catch2 REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(snappy REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(brotli REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(tinygltf REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(Taskflow REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(kissfft REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(bgfx REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(xxHash REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(linalg REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(miniaudio REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(stb REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(utf8.h REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
find_package(pdqsort REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
